...
\clearpage
% ---------------------------------------------------------------------------
\section*{Recommended Tools/Materials to Bring}
\textcolor{red}{Create list of personal items recommended for participants to bring to the workshop, such as aprons, notebooks, personal brushes, etc.}
...
After we work through the slabs, the following section will become apparent why we need to think about thickness of the slabs we are making.\\[5pt]
>>>>>>> b5a393857c67dd15e22db55d699e094f70261858
...
<<<<<<< HEAD
\subsection*{Slip Consistency \& Quick Recipe (for reference)}
\begin{itemize}
\item Basic $\Delta10$ Kohiki Slip Recipe:\\[5pt]
    \rule{1cm}{0pt}
=======
...
<<<<<<< HEAD
    \item Any range in between depending on your application style and decorative goals\\[5pt]
  \end{enumerate}
...
\subsubsection*{What I Notice / What I Would Change (Fill This Out)}
\begin{enumerate}
  ...
  \item One change I would make next time: \hrulefill\\[16pt] \rule{\linewidth}{0.4pt}
\end{enumerate}
...
\textcolor{red}{Create a list of recommended books, articles, and online resources for further study on kohiki slip decoration and wood-fired soda firing.}
